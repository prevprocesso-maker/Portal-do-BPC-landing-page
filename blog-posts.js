...
var THUMBS=[
  ...
  /* 6 — Calendário BPC 2026 */
  thumb('<rect width="800" height="500" fill="#3d1a0a"/><rect x="200" y="100" width="400" height="280" rx="18" fill="rgba(245,237,224,0.08)" stroke="rgba(245,237,224,0.35)" stroke-width="7"/><rect x="200" y="100" width="400" height="60" rx="18" fill="rgba(196,103,58,0.35)"/><rect x="200" y="140" width="400" height="20" rx="0" fill="rgba(196,103,58,0.35)"/><line x1="333" y1="160" x2="333" y2="380" stroke="rgba(245,237,224,0.15)" stroke-width="2"/><line x1="467" y1="160" x2="467" y2="380" stroke="rgba(245,237,224,0.15)" stroke-width="2"/><line x1="200" y1="220" x2="600" y2="220" stroke="rgba(245,237,224,0.12)" stroke-width="2"/><line x1="200" y1="270" x2="600" y2="270" stroke="rgba(245,237,224,0.12)" stroke-width="2"/><line x1="200" y1="320" x2="600" y2="320" stroke="rgba(245,237,224,0.12)" stroke-width="2"/><circle cx="267" cy="245" r="14" fill="rgba(196,103,58,0.45)"/><text x="267" y="250" font-size="14" fill="rgba(245,237,224,0.8)" text-anchor="middle" font-family="sans-serif">26</text><text x="400" y="135" font-size="18" fill="rgba(245,237,224,0.85)" text-anchor="middle" font-family="Georgia,serif" font-weight="bold">2026</text>'),
];

/* ─── Post data ─────────────────────────────────────────────── */
var POSTS=[
  {
    id:0,cat:'BPC Idoso',date:'12 mai 2026',readTime:'6 min',tipo:'Guia',autor:'Equipe CarlosCostaPrev',fontes:['CF/88, art. 203, V','Lei 8.742/93 (LOAS), art. 20','Decreto 6.214/2007','Decreto 8.805/2016 (CadÚnico)','Portal Meu INSS — meu.inss.gov.br'],
    titulo:'Como dar entrada no BPC sem sair de casa',
    desc:'Passo a passo do <strong>pedido pelo Meu INSS</strong>, sem precisar de advogado.',
    intro:'Muita gente não sabe, mas dá para <strong>pedir o BPC</strong> inteiramente pelo celular — sem fila, sem 135, sem ir à agência. Veja como funciona na prática.',
    sections:[
      {h:'O que você precisa antes de começar',body:'<p><strong>Fundamento legal:</strong> o BPC é direito previsto no art. 203, V da Constituição Federal, regulamentado pela Lei 8.742/93 (LOAS) e pelo Decreto 6.214/2007. Não é favor — é garantia constitucional.</p><p>Antes de abrir o app, deixe tudo separado. Pedido incompleto vai para fila de exigência e atrasa meses.</p><ul><li><strong>CPF e RG do requerente</strong> — foto legível (não precisa de cartório).</li><li><strong>CadÚnico atualizado</strong> nos últimos 24 meses (Decreto 8.805/2016). Sem isso o pedido trava antes de chegar ao perito.</li><li><strong>Comprovante de renda de todos os moradores</strong> — holerite, extrato, ou declaração assinada de que não há renda formal.</li><li><strong>Laudo médico (máx. 90 dias)</strong> com CID-10 — obrigatório para BPC deficiente.</li><li><strong>Comprovante de residência</strong> com até 90 dias: conta de luz, água ou gás.</li></ul>'},
    ...
    faq:[{q:'Preciso de advogado para pedir o BPC?',a:'Não. O <strong>pedido do BPC</strong> é gratuito e pode ser feito por qualquer pessoa pelo app <strong>Meu INSS</strong>. Advogado não é obrigatório por lei.'},{q:'Quanto tempo o INSS demora para decidir?',a:'O INSS tem até <strong>90 dias</strong> após a entrega completa dos documentos (Lei 14.331/2022). Na prática, varia de 45 a 90 dias.'},{q:'Posso pedir BPC sem CadÚnico?',a:'Não. O Decreto 8.805/2016 tornou o CadÚnico obrigatório. Sem ele atualizado nos últimos 24 meses, o pedido é rejeitado automaticamente.'},{q:'Qual o valor do BPC em 2026?',a:'R$ 1.621 por mês — equivalente a 1 salário mínimo (Decreto 12.797/2025). Pago enquanto os requisitos forem mantidos.'}],
    cta:'Ficou com dúvida sobre o seu caso?',
    ctaMsg:'Olá! Vi o artigo sobre como dar entrada no BPC e gostaria de orientação.'
  },
  {
    id:1,cat:'Recurso',date:'08 mai 2026',readTime:'7 min',tipo:'Artigo',autor:'Equipe CarlosCostaPrev',fontes:['Lei 8.742/93 (LOAS), art. 20, §3º','Lei 13.982/2020, art. 20-A','Súmula 636 do STJ','Lei 8.213/91, art. 126 (prazo recursal)','Decreto 6.214/2007, art. 4º'],
    titulo:'INSS negou? Veja os 4 motivos mais comuns',
    desc:'O que fazer quando o <strong>BPC é indeferido</strong> e <strong>como recorrer</strong>.',
    intro:'A <strong>negativa do BPC</strong> não é o fim — é o começo de um processo. Na maioria dos casos os motivos são corrigíveis, mas você tem apenas 30 dias para agir.',
    sections:[
      {h:'1. Renda per capita acima do limite',body:'<p>O BPC exige renda familiar per capita de até ¼ do salário mínimo (R$ 405,25 em 2026), conforme o art. 20, §3º da Lei 8.742/93. O INSS cruza CadÚnico com Receita Federal — qualquer renda informal de outro morador que apareça nos sistemas pode estourar o limite.</p><p><strong>O que fazer:</strong> revise quem está no grupo familiar e quais rendas foram declaradas. A lei 13.982/2020 permite excluir: BPC já recebido, aposentadoria de idoso de até 1 salário mínimo (Súmula 636 STJ) e Bolsa Família. Muitas famílias que têm direito são negadas por não conhecer essas exclusões legais.</p>'},
      ...
      {h:'Como entrar com recurso',body:'<p>Você tem <strong>30 dias</strong> (art. 126 da Lei 8.213/91) a partir da carta de indeferimento para protocolar recurso no INSS — gratuito, pelo Meu INSS ou na agência. O recurso vai para a Junta de Recursos (JR). Se a JR negar, cabe recurso ao CRPS e depois ação judicial.</p><p>Com recurso bem fundamentado, 35–45% dos casos são revertidos administrativamente. Na esfera judicial esse número sobe para 60% ou mais.</p>'},
    ],
    faq:[{q:'Qual o prazo para recorrer da negativa do BPC?',a:'<strong>30 dias</strong> a partir da ciência da negativa, conforme o art. 126 da Lei 8.213/91. Perder esse prazo exige <strong>novo requerimento</strong> do zero.'},{q:'O recurso do BPC é gratuito?',a:'Sim. O <strong>recurso administrativo no CRPS</strong> é gratuito e pode ser feito pelo <strong>Meu INSS</strong> ou presencialmente na agência.'},{q:'O que é a Súmula 636 do STJ?',a:'Permite excluir do cálculo de renda a aposentadoria de até 1 salário mínimo recebida por idoso do mesmo grupo familiar. Muda o resultado do cálculo em muitos casos.'},{q:'Se o recurso administrativo for negado, acabou?',a:'Não. Ainda cabe ação judicial. Na Justiça, o juiz pode determinar nova perícia e reanalisar toda a documentação.'}],
  ...
  {
    id:2,cat:'Documentos',date:'02 mai 2026',readTime:'5 min',tipo:'Guia',autor:'Equipe CarlosCostaPrev',fontes:['Decreto 8.805/2016 (CadÚnico obrigatório)','Lei 8.742/93 (LOAS)','Portaria MDS nº 810/2022','gov.br/mds — Cadastro Único'],
    titulo:'CadÚnico atualizado: por que é tão importante',
    desc:'Sem <strong>CadÚnico em dia</strong>, o <strong>BPC pode ser bloqueado</strong> mesmo após aprovação.',
    ...
    sections:[
      ...
      {h:'Por que precisa estar atualizado',body:'<p>O Decreto 8.805/2016 exige CadÚnico atualizado nos últimos <strong>24 meses</strong> para que o BPC seja concedido ou mantido. O sistema do INSS verifica a data antes de qualquer análise humana.</p><p>Cadastro com mais de 24 meses? O pedido é arquivado por "requisito formal não atendido" — uma recusa que não tem nada a ver com sua condição médica ou financeira real. Frustrante, mas 100% evitável.</p>'},
    ...
    faq:[{q:'O CadÚnico é obrigatório para o BPC?',a:'Sim, desde o <strong>Decreto 8.805/2016</strong>. Sem cadastro válido (atualizado nos últimos <strong>24 meses</strong>), o INSS rejeita automaticamente.'},{q:'Onde faço o CadÚnico?',a:'No <strong>CRAS</strong> (Centro de Referência de Assistência Social) do seu bairro. Leve documentos de todos os moradores. Geralmente não precisa de agendamento.'},{q:'Já recebo BPC. Preciso atualizar o CadÚnico?',a:'Sim. A cada 24 meses. Se vencer, o governo pode bloquear o pagamento. O desbloqueio leva de 30 a 90 dias.'},{q:'Quanto tempo o INSS leva para ver a atualização?',a:'O sistema do INSS sincroniza com o CadÚnico em até 72 horas. Só faça o requerimento do BPC depois desse prazo.'}],
    cta:'Precisa de orientação sobre o CadÚnico ou o BPC?',
    ctaMsg:'Olá! Preciso de orientação sobre o CadÚnico e o BPC.'
  },
  {
    id:3,cat:'BPC deficiente',date:'28 abr 2026',readTime:'6 min',tipo:'Artigo',autor:'Equipe CarlosCostaPrev',fontes:['Lei 12.764/2012, art. 1º, §2º (Berenice Piana)','Lei 13.146/2015, art. 2º (Estatuto da Pessoa com Deficiência)','Decreto 6.214/2007','DSM-5 — Manual Diagnóstico','CID-10 F84.0'],
    titulo:'Lei Berenice Piana e o BPC para autistas',
    desc:'O que diz a lei e como aplicar no caso do seu filho ou familiar. <strong>Autismo tem direito ao BPC.</strong>',
    intro:'Desde 2012 a Lei Berenice Piana reconhece o <strong>autismo como deficiência</strong> para todos os fins legais. Isso abriu o caminho para que pessoas com TEA de qualquer grau possam pleitear o BPC.',
    sections:[
    ...
    faq:[{q:'Autismo de nível 1 (leve) dá direito ao BPC?',a:'A Lei 12.764/2012 não distingue graus — todo <strong>TEA é deficiência por lei</strong>. O que o INSS avalia é o impacto funcional. Nível 1 com boa funcionalidade tem chance menor, mas não é vedado.'},{q:'Criança com autismo precisa de laudo de qual médico?',a:'Neuropediatra, neurologista ou psiquiatra. O laudo deve ter CID F84.0 e, idealmente, o nível de suporte (1, 2 ou 3 pelo DSM-5).'},{q:'O que é o BPC-Escola?',a:'Programa que acompanha crianças e adolescentes com deficiência que recebem BPC, com visitas domiciliares e acompanhamento escolar. Basta manter o CadÚnico atualizado.'},{q:'A pessoa com TEA pode trabalhar e manter o BPC?',a:'A Lei 13.146/2015 permite, em casos específicos, <strong>conciliar trabalho e BPC</strong> — com suspensão (não cancelamento) do benefício. Analise com cuidado antes de assinar carteira.'}],
  ...
  {
    id:4,cat:'Renda',date:'20 abr 2026',readTime:'7 min',tipo:'Guia',autor:'Equipe CarlosCostaPrev',fontes:['Lei 8.742/93, art. 20, §1º e §3º','Lei 13.982/2020, art. 20-A','Súmula 636 do STJ','Decreto 6.214/2007, art. 4º','Lei 14.176/2021'],
    titulo:'Como calcular a renda per capita corretamente',
    desc:'Erros no <strong>cálculo da renda per capita</strong> são a causa mais comum de negativa evitável.',
    intro:'O <strong>cálculo da renda per capita do BPC</strong> parece simples — renda total dividida pelo número de moradores — mas os detalhes sobre o que conta (e o que não conta) costumam decidir entre aprovação e negativa.',
    sections:[
    ...
    faq:[{q:'Qual o limite de renda per capita para o BPC em 2026?',a:'<strong>R$ 405,25</strong> por pessoa — equivale a <strong>¼ do salário mínimo</strong> de R$ 1.621 (art. 20, §3º da Lei 8.742/93).'},{q:'Bolsa Família entra no cálculo de renda do BPC?',a:'Não. <strong>Bolsa Família</strong> e programas de transferência de renda são <strong>excluídos do cálculo</strong> (Lei 13.982/2020, art. 20-A).'},{q:'Aposentadoria de avó que mora junto conta?',a:'Se for de até 1 salário mínimo e a avó tiver 65+, NÃO conta — por força da Súmula 636 do STJ. Essa exclusão muda o resultado em muitas famílias.'},{q:'Filho maior de 21 anos morando junto conta?',a:'Depende. Filho maior de 21 sem deficiência, com renda própria e economia separada, pode ser excluído do grupo familiar — desde que o CadÚnico reflita essa separação.'}],
    cta:'Quer calcular a renda per capita do seu caso?',
    ctaMsg:'Olá! Preciso de ajuda para calcular a renda per capita para o BPC.'
  },
  {
    id:5,cat:'Perícia',date:'12 abr 2026',readTime:'8 min',tipo:'Guia',autor:'Equipe CarlosCostaPrev',fontes:['Lei 13.146/2015, art. 2º (avaliação biopsicossocial)','Decreto 6.214/2007, art. 16','CIF — OMS','IF-BPC (Instrumento de Avaliação)','Lei 8.742/93, art. 20, §6º'],
    titulo:'Perícia médica do INSS: como se preparar',
    desc:'<strong>Documentos para perícia</strong>, laudos e <strong>o que dizer ao perito</strong> para não perder o BPC.',
    intro:'A <strong>perícia médica do INSS</strong> é o momento mais crítico do processo. Erros evitáveis — aparecer em dia bom, esquecer documentos, minimizar sintomas — derrubam pedidos que deveriam ser aprovados.',
    sections:[
      {h:'O que o perito avalia de verdade',body:'<p>O perito usa a Classificação Internacional de Funcionalidade (CIF), conforme o art. 2º da Lei 13.146/2015 (Estatuto da Pessoa com Deficiência) — não apenas o diagnóstico. Ele avalia o <strong>impacto da condição na vida real</strong>: o que a pessoa não consegue fazer sozinha, que barreiras encontra, qual nível de suporte precisa.</p><p>Um diagnóstico grave com boa funcionalidade pode ser negado. Uma condição aparentemente leve com alto impacto documentado pode ser aprovada. A documentação é tudo.</p>'},
    ...
    faq:[{q:'O que o perito do INSS avalia na perícia do BPC?',a:'Avalia o <strong>impacto funcional</strong> pela <strong>CIF</strong> (Classificação Internacional de Funcionalidade), conforme art. 2º da Lei 13.146/2015. Não é só o diagnóstico — é o que a pessoa consegue ou não fazer.'},{q:'Posso levar acompanhante na perícia?',a:'Sim. É direito garantido pelo art. 44 da Lei 13.146/2015. O acompanhante pode complementar informações que o periciado esquece ou minimiza.'},{q:'Devo tomar minha medicação antes da perícia?',a:'Siga o tratamento normal, mas evite tomar <strong>medicação forte</strong> minutos antes. Os sintomas ficam mascarados e o perito vê uma pessoa que parece estável.'},{q:'Posso remarcar a perícia?',a:'Sim, pelo Meu INSS ou pelo 135. Faça com antecedência — falta sem justificativa pode indeferir o pedido automaticamente.'}],
  ...
  {
    id:6,cat:'BPC/LOAS',date:'21 jun 2026',readTime:'4 min',tipo:'Guia',autor:'Equipe CarlosCostaPrev',fontes:['Calendário oficial do INSS 2026','Portal Meu INSS — meu.inss.gov.br','Decreto 6.214/2007','Central 135'],
    titulo:'Calendário BPC/LOAS 2026: datas de pagamento',
    desc:'Datas de pagamento do <strong>BPC mês a mês</strong>, por número final do benefício.',
    intro:'O calendário do BPC/LOAS 2026 segue o cronograma do INSS. Os depósitos são organizados pelo número final do cartão de benefício e começam nos últimos dias úteis de cada mês. O valor do BPC em 2026 é de <strong>R$ 1.621,00</strong>.',
    sections:[
      {h:'Como funciona o calendário do BPC',body:'<p>O BPC/LOAS segue o <strong>calendário oficial do INSS</strong> para benefícios de até um salário mínimo. Os pagamentos são escalonados por número final do benefício, começando pelo final 1 e terminando no final 0.</p><p>Para descobrir o seu número final, olhe o número do benefício no cartão ou no extrato do <strong>Meu INSS</strong>. Desconsidere o dígito depois do traço. Exemplo: se o número for 123456789-0, o <strong>final é 9</strong>.</p>'},
      {h:'Datas de pagamento 2026 (1º semestre)',body:'<ul><li><strong>Janeiro:</strong> 26/01 (final 1) a 06/02 (final 0)</li><li><strong>Fevereiro:</strong> 24/02 (final 1) a 07/03 (final 0)</li><li><strong>Março:</strong> 25/03 (final 1) a 07/04 (final 0)</li><li><strong>Abril:</strong> 25/04 (final 1) a 08/05 (final 0)</li><li><strong>Maio:</strong> 25/05 (final 1) a 08/06 (final 0)</li><li><strong>Junho:</strong> 24/06 (final 1) a 07/07 (final 0)</li></ul><p><em>Julho a dezembro:</em> o INSS divulga as datas mês a mês. Acompanhe pelo Meu INSS ou Central 135.</p>'},
      {h:'Como consultar a data do seu pagamento',body:'<p>Acesse o site ou app <strong>Meu INSS</strong> com login <strong>gov.br</strong>. Clique em "<strong>Extrato de Pagamento</strong>". Ali aparece a data exata do próximo depósito e o valor atualizado.</p><p>Também é possível ligar para a <strong>Central 135</strong> (segunda a sábado, 7h às 22h).</p>'},
      {h:'O BPC tem 13º salário?',body:'<p><strong>Não.</strong> O BPC é um benefício assistencial, não previdenciário. Por isso, <strong>não há pagamento de 13º salário</strong> nem direito a pensão por morte.</p>'},
      {h:'O que fazer se o pagamento atrasar',body:'<p>Se o depósito não caiu na data prevista, verifique no <strong>Meu INSS</strong> se há pendência. Causas comuns:</p><ul><li><strong>CadÚnico desatualizado</strong> — renove a cada 2 anos no CRAS</li><li><strong>Revisão do INSS (pente-fino)</strong> — suspensão temporária para revisão</li><li><strong>Bloqueio por falta de atualização cadastral</strong></li></ul><p>Procure o <strong>CRAS</strong> da sua cidade para regularizar.</p>'},
    ],
    faq:[{q:'Quando cai o BPC em 2026?',a:'O BPC segue o calendário do INSS: final 1 recebe primeiro, final 0 por último. Em junho, por exemplo, de 24/06 a 07/07.'},{q:'Qual o valor do BPC em 2026?',a:'<strong>R$ 1.621,00</strong> por mês — um salário mínimo. Sem descontos.'},{q:'O BPC tem 13º?',a:'Não. O BPC é benefício assistencial — não há 13º nem pensão por morte.'},{q:'Como descobrir meu número final?',a:'No cartão ou extrato do Meu INSS. Desconsidere o dígito após o traço. Ex: 123456789-0 → final <strong>9</strong>.'}],
    cta:'Precisa de ajuda com o BPC?',
    ctaMsg:'Olá! Vi o calendário do BPC 2026 e preciso de orientação.'
  }
];
...
(function(){
  ...
  st.textContent='.bpc-art p{margin:0 0 18px}.bpc-art ul,.bpc-art ol{margin:0 0 18px;padding-left:28px}.bpc-art li{margin-bottom:9px;line-height:1.65}.bpc-art strong{color:var(--ink-900);font-weight:600}.bpc-art em{color:var(--terra-400);font-style:italic}.bpc-bc{display:flex;align-items:center;gap:8px;font-family:var(--font-sans);font-size:14px;color:var(--ink-500);margin-bottom:24px;flex-wrap:wrap}.bpc-bc a{color:var(--ink-500);text-decoration:none}.bpc-bc a:hover{color:var(--terra-400)}.bpc-bc .sep{color:var(--ink-300)}.bpc-faq{margin:48px 0 0;padding:32px 0 0;border-top:2px solid var(--line)}.bpc-faq h3{font-family:var(--font-serif);font-size:1.5rem;margin:0 0 20px;color:var(--ink-900)}.bpc-faq-item{padding:18px 0;border-bottom:1px solid var(--line)}.bpc-faq-item:last-child{border-bottom:none}.bpc-faq-q{font-family:var(--font-serif);font-size:1.05rem;font-weight:600;color:var(--ink-900);margin:0 0 8px}.bpc-faq-a{font-size:15px;line-height:1.65;color:var(--ink-700);margin:0}';
