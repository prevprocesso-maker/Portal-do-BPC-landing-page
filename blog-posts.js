...
var POSTS=[
  ...
  },
  {
    ...
    sections:[
      {h:'A fórmula básica',body:'<p><strong>Renda per capita = soma das rendas de todos do grupo familiar ÷ número de membros.</strong></p><p>Em 2026, o limite é de <strong>R$ 353,50</strong> (¼ do salário mínimo de R$ 1.412). Se o resultado for menor que esse valor, o critério de renda está atendido.</p>'},
