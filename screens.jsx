...
/* Merge extra patologia details from patologia-data-extra.jsx */
if (window.PATOLOGIA_DETAIL_EXTRA) {
  Object.assign(PATOLOGIA_DETAIL, window.PATOLOGIA_DETAIL_EXTRA);
}
