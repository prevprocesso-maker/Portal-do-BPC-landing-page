...
(function() {
  ...
  function fixFoto() {
    ...
    s.textContent = [
      ...
      '.sim2 .support{order:-1!important;min-height:0!important;background:linear-gradient(135deg,#2a2018,#1f1812)!important;padding:14px 18px!important;display:flex!important;flex-direction:row!important;align-items:center!important;gap:14px!important;border-radius:22px 22px 0 0!important;}',
      '.sim2 .support::after{display:none!important;}',
      '.sim2 .who{flex:1!important;}',
      '.sim2 .reassure{display:none!important;}',
      '.sim2 .pbar-wrap{margin-top:0!important;min-width:120px!important;}',
      '.sim2 .pbar-label{font-size:11px!important;margin-bottom:5px!important;}',
      '.sim2 .pbar{gap:3px!important;}',
      '.sim2 .trust{display:none!important;}',
      '}'
    ].join('');
