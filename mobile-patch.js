      ...
      e('header', { className: `header ${scrolled ? 'scrolled' : ''}` },
        e('div', { className: 'container header-inner' },
          e('a', { href: '#/', className: 'header-logo', onClick: (ev) => { ev.preventDefault(); onNavigate('home'); } },
            e('img', { src: 'assets/logo-portal-bpc-header-400.webp?v=20260820-logoheader1', alt: 'Portal do BPC', className: 'header-logo-mark', style: { objectFit: 'cover' } }),
      ...
      e('nav', {
        ...
        e('div', { className: 'mobile-drawer-header' },
          e('a', {
            ...
            e('img', { src: 'assets/logo-portal-bpc-header-200.webp?v=20260820-logoheader1', alt: 'Portal do BPC', style: { height: 42, width: 150, objectFit: 'cover', objectPosition: 'center' } }),
            e('span', { className: 'header-logo-text' },
